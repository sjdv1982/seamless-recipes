...
#ipython3 $interactive_flag $currdir/oarcluster-mini.py -- --host $SEAMLESS_ASSISTANT_HOST --port $DASK_SCHEDULER_PORT

python3 -u $interactive_flag $currdir/oarcluster-mini.py --host $SEAMLESS_ASSISTANT_HOST --port $DASK_SCHEDULER_PORT